...
with imcol3:
    st.write("")
st.markdown("<p style='text-align: center; color: black; font-size:23px;'><span style='font-weight: bold'></span>Working with a Large Language Model (LLM) OpenAI vs Google</p>", unsafe_allow_html=True)
...
#---------Side bar-------#
with st.sidebar:
    selected = st.selectbox("",['Vertex AI'],key='text')
